...
echo "→ testing";     node scripts/test-auth.mjs >/dev/null && node scripts/test-customer.mjs >/dev/null && node scripts/test-valuation.mjs >/dev/null && echo "   auth/policy/customer/valuation ✓"
