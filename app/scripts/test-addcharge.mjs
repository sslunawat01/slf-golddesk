...
eq("a fixed ₹100 + 18% GST defaults to ₹118",
   chargeDefault({ calc: "flat", amount_paise: 10000, gst_pct: 18 }, 4000000),
   { manual: false, basePaise: 10000, gstPaise: 1800, totalPaise: 11800 });
eq("0.25% of ₹40,000 floors at ₹100",
   chargeDefault({ calc: "pct_of_sanction", pct: 0.25, min_paise: 10000, max_paise: 150000, gst_pct: 18 },
...
eq("a master row with neither amount nor pct is at actuals",
   chargeDefault({ calc: "flat", amount_paise: null, gst_pct: 18 }, 4000000).manual, true);
